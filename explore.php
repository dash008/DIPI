        ...
        <div class="navbar navbar-light" style="background-color: #ead95c;">
          <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
              <img class=brand_img src="assets/dipi.png" width="" height="30" alt="">             
            </a>
            <a href="access.php">
              <img src="assets/baseline-face-24px.svg" alt="HTML tutorial" style="width:24px;height:24px;border:0">
              Perfil
            </a>
            <a href="logout.php">
      ...
      <main role="main">
        ...
        <section class="jumbotron text-center">
          ...
          <div class="container">
            ...
            <p>
              <button  onclick="loop();"class="btn btn-primary my-2">Iniciar partida</button>
...
<?php
                ...
                $id = $_SESSION['id'];
                $sql = "SELECT usuarios.username,creations.imagen 
                        FROM usuarios 
                        LEFT JOIN creations ON usuarios.id = creations.id_creador_original
                        ORDER BY creations.id_creador_original DESC";
                ...
                while($row = $result->fetch_assoc())
                {
                  ...
                  echo '<figure>';
                  echo '<img class="img_exp" src="data:image/png;base64,'.$row['imagen'].'"/>';
                  echo '<figcaption>'.'Creado por: '.$row['username'].'</figcaption>';
                  echo '</figure>';
?>
                                    
                  <input href="#" type="button" class="btn btn-primary my-2 btn-dark" onClick="createFileInput(loadImagen('<?php echo $data?>'));" value="Cargar lienzo" />
<?php
                  echo '</div>';                  
                }
